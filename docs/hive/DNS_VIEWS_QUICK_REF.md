...
Automated: `bash scripts/verify-dns-views.sh --hairpin` or `bash scripts/verify-dns-views.sh --hairpin mftdrv.misfitsds.olutechsys.com`
...
- `otsorundscore.olutechsys.com` → `*` **A** → `10.0.1.15`
- Optional: `misfitsds.olutechsys.com` → `*` **A** → `10.0.1.24`
